...
CATALOG: List[SoftwareEntry] = [
    ...
    SoftwareEntry(
        ...
        description="Open-source GOG, Amazon and Epic Games launcher for Linux.",
        category="Gaming",
        icon="⚔️",
        website="https://heroicgameslauncher.com",
        install_specs={
            "flatpak": PackageSpec(packages=["com.heroicgameslauncher.hgl"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="bottles",
        name="Bottles",
        description="Run Windows software and games on Linux with ease.",
        category="Gaming",
        icon="🍷",
        website="https://usebottles.com",
        install_specs={
            "flatpak": PackageSpec(packages=["com.usebottles.bottles"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="gamemode",
        name="GameMode",
        description="Daemon/lib combo that optimises Linux system performance on demand.",
        category="Gaming",
        icon="⚡",
    ...
    SoftwareEntry(
        id="mangohud",
        name="MangoHud",
        description="Vulkan and OpenGL overlay for monitoring FPS, temps, and more.",
        category="Gaming",
        icon="📊",
    ...
    SoftwareEntry(
        id="protonup-qt",
        name="ProtonUp-Qt",
        description="Install and manage Proton-GE and other compatibility tools.",
        category="Gaming",
        icon="🧪",
        website="https://davidotek.github.io/protonup-qt",
        install_specs={
            "flatpak": PackageSpec(packages=["net.davidotek.pupgui2"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    ...
    SoftwareEntry(
        id="bitwarden",
        name="Bitwarden",
        description="Open-source password manager — store, sync, and share sensitive data.",
        category="Password Managers",
        icon="🔑",
        website="https://bitwarden.com",
        install_specs={
            "flatpak": PackageSpec(packages=["com.bitwarden.desktop"], flatpak_remote="flathub"),
            "snap":    _s("bitwarden"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            ...
            "pacman":  _s("keepassxc"),
            "zypper":  _s("keepassxc"),
            "flatpak": PackageSpec(packages=["org.keepassxc.KeePassXC"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="1password",
        name="1Password",
        description="The world's most-loved password manager. Secure every sign-in.",
        category="Password Managers",
        icon="🔐",
        ...
        install_specs={
            "apt": PackageSpec(
                packages=["1password"],
                pre_commands=[
                    "curl -sS https://downloads.1password.com/linux/keys/1password.asc | gpg --dearmor | tee /usr/share/keyrings/1password-archive-keyring.gpg > /dev/null",
    ...
    SoftwareEntry(
        id="kdenlive",
        name="Kdenlive",
        description="KDE's free and open-source video editor.",
        ...
        install_specs={
            ...
            "pacman":  _s("kdenlive"),
            "zypper":  _s("kdenlive"),
            "flatpak": PackageSpec(packages=["org.kde.kdenlive"], flatpak_remote="flathub"),
            "snap":    _s("kdenlive"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            "flatpak": PackageSpec(packages=["org.shotcut.Shotcut"], flatpak_remote="flathub"),
            "snap":    _s("shotcut"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            ...
            "dnf":     _s("openshot"),
            "pacman":  _s("openshot"),
            "flatpak": PackageSpec(packages=["org.openshot.OpenShot"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    ...
    SoftwareEntry(
        ...
        install_specs={
            ...
            "dnf":     _s("alacritty"),
            "pacman":  _s("alacritty"),
            "flatpak": PackageSpec(packages=["org.alacritty.Alacritty"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            ...
            "dnf":     _s("kitty"),
            "pacman":  _s("kitty"),
            "flatpak": PackageSpec(packages=["net.kovidgoyal.kitty"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            "apt": PackageSpec(
                packages=["wezterm"],
                pre_commands=[
                    "curl -fsSL https://apt.fury.io/wez/gpg.key | gpg --dearmor | tee /usr/share/keyrings/wezterm.gpg > /dev/null",
                    'echo "deb [signed-by=/usr/share/keyrings/wezterm.gpg] https://apt.fury.io/wez/ * *" | tee /etc/apt/sources.list.d/wezterm.list',
                    "apt-get update",
                ],
            ),
            "flatpak": PackageSpec(packages=["org.wezfurlong.wezterm"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="tilix",
        name="Tilix",
        description="Tiling terminal emulator for GNOME using GTK+ 3.",
        category="Terminal Emulators",
        icon="🪟",
        ...
        install_specs={
            "apt":     _s("tilix"),
            "dnf":     _s("tilix"),
            "flatpak": PackageSpec(packages=["com.gexperts.Tilix"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    ...
    SoftwareEntry(
        ...
        install_specs={
            ...
            "flatpak": PackageSpec(packages=["com.protonvpn.www"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            "apt":    _s("wireguard"),
            "dnf":    _s("wireguard-tools"),
            "pacman": _s("wireguard-tools"),
            "zypper": _s("wireguard-tools"),
        },
    ),
    SoftwareEntry(
        id="mullvad",
    ...
    SoftwareEntry(
        ...
        install_specs={
            "flatpak": PackageSpec(packages=["md.obsidian.Obsidian"], flatpak_remote="flathub"),
            "snap":    _s("obsidian"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="joplin",
        name="Joplin",
        description="Open-source note-taking and to-do app with synchronisation capabilities.",
        category="Note Taking",
        icon="📓",
        website="https://joplinapp.org",
        install_specs={
            "flatpak": PackageSpec(packages=["net.cozic.joplin_desktop"], flatpak_remote="flathub"),
            "snap":    _s("joplin-desktop"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        id="logseq",
        name="Logseq",
        description="Privacy-first, open-source knowledge management platform.",
        category="Note Taking",
        icon="📋",
        website="https://logseq.com",
        install_specs={
            "flatpak": PackageSpec(packages=["com.logseq.Logseq"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
    SoftwareEntry(
        ...
        install_specs={
            "apt":     _s("cherrytree"),
            "dnf":     _s("cherrytree"),
            "pacman":  _s("cherrytree"),
            "flatpak": PackageSpec(packages=["com.giuspen.cherrytree"], flatpak_remote="flathub"),
        },
        preferred_pm="flatpak",
    ),
]
